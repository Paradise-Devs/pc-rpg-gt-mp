...
var weaponHashes = [
    { class: 0, cost: 5, hash: 453432689 },
    { class: 0, cost: 5, hash: -1716589765 },
    { class: 0, cost: 5, hash: -1045183535 },
    { class: 1, cost: 10, hash: 324215364 },
    { class: 1, cost: 25, hash: 736523883 },
    { class: 1, cost: 10, hash: 1627465347 },
    { class: 2, cost: 50, hash: -1074790547 },
    { class: 2, cost: 50, hash: 2132975508 },
    { class: 3, cost: 500, hash: 100416529 },
    { class: 4, cost: 75, hash: 487013001 },
...
API.onResourceStart.connect(() => {
    ...
    for (var group in groupedWeapons) {
        if (!groupedWeapons.hasOwnProperty(group))
            continue;
        var groupName = group;
